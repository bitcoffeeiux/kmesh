...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang  --cflags $EXTRA_CFLAGS --cflags $EXTRA_CDEFINE KmeshCgroupAccept ../workload/cgroup_accept.c -- -I../workload/include -I../../include
